...
# Noah MQTT Home Assistant Add-on

Fork des ursprünglichen Noah-MQTT Add-ons.

Angepasst für aktuelle Home Assistant Versionen.

Änderungen:
- BUILD_FROM entfernt
- Home Assistant Base Image aktualisiert
- Download der offiziellen noah-mqtt Release-Dateien
- Unterstützung für Home Assistant 2026.x
